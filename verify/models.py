...
class Table(models.Model):
    ...
    usr_identity_status = models.IntegerField(default=3) #(0:申请审核 1:审核通过(不可再申请审核)) 2:不通过删除图片以及数据库条目 3:未申请
    ...
    usr_student_status = models.IntegerField(default=3) #(0:申请审核 1:审核通过(不可再申请审核)) 不通过删除图片以及数据库条目 3:未申请
