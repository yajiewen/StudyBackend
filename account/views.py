...
def usr_add(request): #创建账号
    if request.method == 'POST':
        ...
        if response_data['uname_exist']=='no' and response_data['uemail_exist']=='no':
            ...
            message = '<tbody><tr><td width="600"valign="top"class="w100"><table border="0"cellspacing="0"cellpadding="0"width="600"class="w100"><tbody><tr><td align="center"class="w100 padleftright100"bgcolor="#ffffff"style="background: #fff;padding:0 56px;width:100%"width="600"><table border="0"cellspacing="0"cellpadding="0"width="100%"class="w100"><tbody><tr><td style="padding:0 0 15px 0;">尊敬的'+usr_email+'<strong>wenyajie</strong>,</td></tr><tr><td style="padding:0;">请验证您的电子邮件地址以完成<strong>思达迪</strong>帐户创建。</td></tr><tr><td style="padding:24px 0;"><table border="0"cellspacing="0"cellpadding="10"align="center"><tbody><tr><td align="center"bgcolor="steelblue"style="color:#FFFFFF; font-size:14px;border-radius: 4px;"valign="top"><font face="sans-serif"><a href=' +'"'+VERIFY_BASE_URL+'/account/emailverify/'+usr_email+'/'+'"'+'style="color:#FFFFFF; text-decoration:none;display: inline-block;"rel="noopener"target="_blank">验证电子邮件地址->&nbsp;&nbsp;</a></font></td></tr></tbody></table></td></tr><tr></tr><tr><td style="padding:0 0 15px 0;">我们收到了使用您的电子邮件地址申请<strong>思达迪</strong>帐户的请求。如果您没有发出该请求，则通过发送电子邮件至<a href=""style="color:#41727E;"rel="noopener"target="_blank">eudtocher@163.com</a>来提交帮助请求.</td></tr><tr><td style="padding:0;"><strong style="color:#766f6e;">谢谢,</strong><br><strong style="color:#766f6e;">思达迪帐户团队</strong></td></tr></tbody></table></td></tr></tbody></table><table width="600"background="https://www.oracle.com/a/ocom/img/profile-email/bottom-texture.png"valign="bottom"class="w100"style="background: url(https://www.oracle.com/a/ocom/img/profile-email/bottom-texture.png) no-repeat top center;"><tbody><tr><td height="48"></td></tr></tbody></table></td></tr></tbody>'
